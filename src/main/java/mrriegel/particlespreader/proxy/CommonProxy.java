...
public class CommonProxy {
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		RecipeHelper.addShapedOreRecipe(new ItemStack(ParticleSpreader.spreader), "gdg", "dld", "gdg", 'g', "blockGlass", 'd', "dye", 'l', "dustGlowstone");
		RecipeHelper.addShapelessRecipe(new ItemStack(ParticleSpreader.spreader), ParticleSpreader.spreader);
	}
